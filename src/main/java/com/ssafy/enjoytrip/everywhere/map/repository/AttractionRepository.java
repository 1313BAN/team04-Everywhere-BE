...
public interface AttractionRepository extends JpaRepository<Attraction, Long> {
    ...
    List<AttractionSimpleResponse> findWithinBoundsWithLimit(@Param("swLat") double swLat, @Param("neLat") double neLat, @Param("swLng") double swLng, @Param("neLng") double neLng, Pageable pageable
    );
}